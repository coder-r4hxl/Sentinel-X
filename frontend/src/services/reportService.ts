  ...
  const findings = [
    {
      ...
      action: 'Maintain current settings for session stability.',
    },
    {
      title: 'Clipboard access unavailable',
      severity: 'warning' as const,
      description: 'Clipboard access is not exposed within the current browser context.',
      action: 'Allow clipboard access if you want richer in-browser handoff workflows.',
    },
    {
      title: 'Notifications denied',
      severity: 'warning' as const,
      description: 'Notifications are denied, which may reduce in-session guidance.',
      action: 'Enable notifications for better survey and alert prompts.',
    },
    {
      title: 'Browser compatibility is strong',
      severity: 'recommendation' as const,
      description: 'The current browser configuration supports the required runtime features.',
      action: 'Keep the browser updated to preserve compatibility.',
    },
  ];
